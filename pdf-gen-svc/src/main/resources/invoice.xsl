...
<xsl:stylesheet version="2.0"
        ...
        <fo:root>
            ...
            <fo:page-sequence master-reference="A4-portrait">
                <fo:flow flow-name="xsl-region-body">
                            ...
                            <fo:table-row>
                                ...
                                <fo:table-cell text-align="left">
                                    <fo:block font-size="15pt" font-weight="bold" margin-top="7pt">
                                        JPM COIN SYSTEM | Invoice Statement
                                    </fo:block>
                                 </fo:table-cell>
                                <fo:table-cell text-align="left">
                    ...
                    <fo:block margin-top="10px" xsl:use-attribute-sets=""></fo:block>
                    <fo:block margin-top="10px"
                              xsl:use-attribute-sets="myfont">
    ...
    <xsl:template name="statementsummary">
        <fo:table width="75%" table-layout="fixed" font-size="9pt">
                ...
                <fo:table-row>
                    <fo:table-cell padding="1mm">
                        <fo:block font-weight="bold" text-align="left">
                            For any queries regarding the invoice statement, please contact JPM Coin Systems at: onyx.billing@jpmchase.com
                        </fo:block>
                    </fo:table-cell>
                </fo:table-row>
            </fo:table-body>
