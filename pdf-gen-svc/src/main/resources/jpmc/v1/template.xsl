                    ...
                    <fo:table-cell padding-bottom="1mm" padding-top="1mm">
                        <xsl:if test="(payoutInvoice='true') and (totalDueAmount != 0)">
                            <fo:block margin-bottom="15px">The Amount of
                                <fo:inline font-weight="bold">
                                    $
                                    <xsl:value-of select="format-number(totalDueAmount, '###,##0.00')"/>
                                </fo:inline>
                        ...
                        <xsl:if test="(payoutInvoice='false') and (totalDueAmount != 0)">
                            <fo:block margin-bottom="15px">The Amount of
                                ...
                                will be debited from the account on file within 15 business days of the statement date.
                            </fo:block>
                        </xsl:if>
            ...
            <fo:table-body>
                <fo:table-row>
                    ...
                    <fo:table-cell padding-bottom="1mm" padding-top="1mm"
                        ...
                        <fo:block>
                            $
                            <xsl:value-of select="format-number(subTotalAmount, '###,##0.00')"/>
                ...
                <xsl:if test="adjustmentList">
                    <fo:table-row>
                        ...
                        <fo:table-cell padding-bottom="1mm" padding-top="1mm"
                            ...
                            <fo:block>
                                $
                                <xsl:value-of select="format-number(adjustmentAmount, '###,##0.00')"/>
