        ...
        <fo:table width="100%" table-layout="fixed" font-size="8pt">
            ...
            <fo:table-header>
                <fo:table-row font-weight="bold"
                    ...
                    <fo:table-cell  padding-bottom="1mm" padding-top="1mm" display-align="after" text-align="center">
                        <fo:block>Total Charge (Base Ccy)</fo:block>
                    </fo:table-cell>
                </fo:table-row>
            </fo:table-header>
            <fo:table-body>
                ...
                <xsl:for-each select="accountWithInvoiceItems">
                    ...
                    <xsl:for-each select="invoiceItems">
                        <fo:table-row width="100%">
                            ...
                            <fo:table-cell text-align="right" padding-bottom="1mm" padding-top="1mm">
                                <fo:block>
                                    <xsl:value-of select="feeRate" />
                                </fo:block>
                            </fo:table-cell>
                            <fo:table-cell text-align="right" padding-bottom="1mm" padding-top="1mm">
                                <fo:block>
                                    $&#160;<xsl:value-of select="totalChargeInUSD"/>
                                </fo:block>
                            </fo:table-cell>
                            <fo:table-cell text-align="right" padding-bottom="1mm" padding-top="1mm">
                                <fo:block>
                                    <xsl:value-of select="currencySymbol"/>&#160;<xsl:value-of select="totalChargeInBaseCurrency"/>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                    </xsl:for-each>
                    <fo:table-row width="100%">
                        ...
                        <fo:table-cell text-align="right" padding-bottom="1mm" padding-top="1mm">
                            <fo:block>
                                $&#160;<xsl:value-of select="subTotalOfUsdAmount"/>
                            </fo:block>
                        </fo:table-cell>
                        <fo:table-cell text-align="right" padding-bottom="1mm" padding-top="1mm">
                            <fo:block>
                                <xsl:value-of select="currencySymbol"/>&#160;<xsl:value-of select="subTotalOfBaseAmount"/>
                            </fo:block>
                        </fo:table-cell>
                    </fo:table-row>
                </xsl:for-each>
